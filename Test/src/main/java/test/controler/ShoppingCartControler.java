...
/*	@POST
	...
	*/	
	...
	@Path("/createCart2/{id}")
	@Consumes(MediaType.APPLICATION_JSON)
	public String createCart2(@PathParam("id")Integer id, ListProducts listProducts) {
		
		Integer cartId =ShoppingCartServices.createCart2(id,listProducts);
		
		return "Shopping cart with Id: " + cartId + " was created";
	}
