...
public class ProductControler {
	...
	// metod na sasko sto nema smisla
	@GET
	@Path("/getProductsByCategory/{categoryid}")
	@Produces(MediaType.APPLICATION_JSON)
	public List<Product> getProductsByCategory(@PathParam("categoryid") Integer categoryid,Product product){
		return ProductServices.getProductsByPrice(categoryid, product);
	}
